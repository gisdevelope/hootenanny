...
EdgeMatchSetFinder2::EdgeMatchSetFinder2(NetworkDetailsPtr details, IndexedEdgeMatchSetPtr matchSet,
...
void EdgeMatchSetFinder2::addEdgeMatches(ConstNetworkEdgePtr e1, ConstNetworkEdgePtr e2)
{
...
bool EdgeMatchSetFinder2::_addEdgeMatches(ConstEdgeMatchPtr em)
{
  LOG_TRACE("Adding edge matches...");
  LOG_VART(em);
...
bool EdgeMatchSetFinder2::_addEdgeNeighborsToEnd(ConstEdgeMatchPtr em,
...
bool EdgeMatchSetFinder2::_addEdgeNeighborsToStart(ConstEdgeMatchPtr em,
...
void EdgeMatchSetFinder2::_appendMatch(EdgeMatchPtr em, ConstNetworkEdgePtr e1,
...
QSet<ConstNetworkEdgePtr> EdgeMatchSetFinder2::_getEdgesFromLocation(ConstEdgeLocationPtr l) const
{
...
bool EdgeMatchSetFinder2::_hasConfidentTiePoint(ConstEdgeLocationPtr l) const
{
  bool result;
  if (l->isExtreme(EdgeLocation::SLOPPY_EPSILON))
  {
...
bool EdgeMatchSetFinder2::_isCandidateMatch(ConstEdgeLocationPtr l1, ConstEdgeLocationPtr l2) const
{
  bool result;
...
void EdgeMatchSetFinder2::_prependMatch(EdgeMatchPtr em, ConstNetworkEdgePtr e1,
                                       ConstNetworkEdgePtr e2) const
{
...
bool EdgeMatchSetFinder2::_recordMatch(ConstEdgeMatchPtr em)
{
  ...
  if (score > 0)
  {
    ...
    similarityValuesToIterate[EdgeMatchSetFinder::EDGE_MATCH_SIMILAR_KEY] = em->getSimilarityString();
    similarityValuesToIterate[EdgeMatchSetFinder::EDGE_MATCH_SIMILAR_SECOND_REVERSED_KEY] =
      em->getSecondReversedSimilarityString();
    similarityValuesToIterate[EdgeMatchSetFinder::EDGE_MATCH_SIMILAR_FIRST_REVERSED_KEY] =
         ...
         similarityValsItr != similarityValuesToIterate.end(); ++similarityValsItr)
    {
      existingSimilarMatch =
        _edgeMatchSimilarities->value(similarityValsItr.key())[similarityValsItr.value()];
    ...
    for (similarityValsItr = similarityValuesToIterate.begin();
         similarityValsItr != similarityValuesToIterate.end(); ++similarityValsItr)
    {
      EdgeMatchSimilarity similarity = _edgeMatchSimilarities->value(similarityValsItr.key());
      similarity[similarityValsItr.value()] = newMatch;
      _edgeMatchSimilarities->insert(similarityValsItr.key(), similarity);
    }
...
void EdgeMatchSetFinder2::_addReverseMatch(ConstEdgeMatchPtr edgeMatch, const double score)
{
...
double EdgeMatchSetFinder2::_scoreMatch(ConstEdgeMatchPtr em) const
{
  LOG_TRACE("Scoring match...");
  return _details->getEdgeStringMatchScore(em->getString1(), em->getString2());
}

ConstEdgeSublinePtr EdgeMatchSetFinder2::_snapSublineToString(ConstEdgeStringPtr str,
...
EdgeMatchPtr EdgeMatchSetFinder2::_trimFromEdge(ConstEdgeMatchPtr em)
{
...
EdgeMatchPtr EdgeMatchSetFinder2::_trimToEdge(ConstEdgeMatchPtr em)
{
