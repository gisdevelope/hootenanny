 ...
 */
#ifndef EDGEMATCHSETFINDER2_H
#define EDGEMATCHSETFINDER2_H
...
//  static const QString EDGE_MATCH_SIMILAR_SECOND_REVERSED_KEY;
  ...
  EdgeMatchSetFinder2(NetworkDetailsPtr details, IndexedEdgeMatchSetPtr matchSet,
...
typedef std::shared_ptr<EdgeMatchSetFinder2> EdgeMatchSetFinder2Ptr;
typedef std::shared_ptr<const EdgeMatchSetFinder2> ConstEdgeMatchSetFinder2Ptr;

}

#endif // EDGEMATCHSETFINDER2_H
